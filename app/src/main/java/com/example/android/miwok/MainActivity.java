...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // NUMBERS LISTENER
        TextView textNumber = (TextView) findViewById(R.id.numbers);
        ...
        // COLORS LISTENER
        TextView textColors = (TextView) findViewById(R.id.colors);
        ...
        // PHRASES LISTENER
        TextView textPhrases = (TextView) findViewById(R.id.phrases);
